...
function Numerology(){
    ...
    fontFamily: "'Cormorant Garamond', serif",
            ...
            I’ve always been fascinated by how numbers whisper secrets about who we really are. With Numerology, I take your birth date and name, crunch the numbers, and hand you a clear map of your strengths, challenges, and life’s bigger purpose. It’s like getting a heartfelt letter from the universe. Ready to see what your numbers are saying? 
            <br /><br />
        </p>
